...
The 'supply_chain_optimisation' project was generated by using the default-python template.
...
3. To deploy a development copy of this project, type:
    ...
    `[dev yourname] supply_chain_optimisation_job` to your workspace.
...
4. Similarly, to deploy a production copy, type:
   ...
   (defined in resources/supply_chain_optimisation.job.yml). The schedule
